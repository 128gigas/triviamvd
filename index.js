...
function iniciarContador() {
  ...
  tiempoRestante = 45;
  btnContador.innerText = tiempoRestante;
  btnContador.classList.remove("yellow", "red");
  intervalId = setInterval(() => {
    tiempoRestante--;
    btnContador.innerText = tiempoRestante;
    if (tiempoRestante <= 20) {
      btnContador.classList.add("yellow");
    }
    if (tiempoRestante <= 0) {
      clearInterval(intervalId);
      btnContador.classList.remove("yellow");
      btnContador.classList.add("red");
    }
  }, 1000);
}
